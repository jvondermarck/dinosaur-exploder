...
export default function NavBar({ lang, dict }: { lang: string; dict: any }) {
  ...
  return (
    <nav className="w-full px-2 sm:px-6 py-4 bg-transparent">
        ...
        <div className={`font-retro flex flex-col sm:flex-row gap-2 sm:items-center justify-between `}>
          ...
          <div className={`hidden xl:flex  xs:flex-row gap-2 justify-center`}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`${buttonStyle} shadow-[3px_3px_0px_0px_#A3245C] border-pink-700 text-white bg-pink-600 hover:bg-pink-700 justify-center`}
            >
              <svg
                width="18"
                height="18"
          ...
          <button
            ...
            className=" xl:hidden p-2 border-2 border-green-800 rounded shadow-[2px_2px_0px_0px_theme(colors.green.700)] active:shadow-none active:translate-x-[2px] active:translate-y-[2px] text-green-800 cursor-pointer"
          >
      ...
      {isOpen && (
        <div className="mx-auto md:absolute md:right-6 sm:right-6 z-50 md:ml-auto xl:hidden w-fit flex flex-col gap-4 mt-4 p-4 md:border-2 md:border-green-800 md:bg-white md:shadow-[3px_3px_0px_0px_theme(colors.green.700)] rounded">
          ...
          <div className="lg:hidden flex flex-col sm:flex-row md:flex-col  gap-2">
            {navItems.map((item) => (
              <Link
                ...
                className={`${buttonStyle} border-green-700 text-green-800 bg-white justify-center shadow-[2px_2px_0px_0px_theme(colors.green.700)]`}
              >
                {item.label}
              </Link>
            ))}
          ...
          <hr className="sm:hidden border-green-800/20 w-full" />
          ...
          <div className="flex flex-col sm:flex-row md:flex-col gap-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`${buttonStyle} justify-center shadow-[3px_3px_0px_0px_theme(colors.green.700)] border-green-800 text-green-800 bg-white hover:bg-green-800 hover:text-white hover:border-green-800`}
            >
              <FaGithub size={25} />
              Github
            </a>
