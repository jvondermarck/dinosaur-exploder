...
import com.dinosaur.dinosaurexploder.controller.core.EnemySpawner;
...
public class GameInitializer {
    ...
    public void setCollisionHandler(CollisionHandler collisionHandler) { this.collisionHandler = collisionHandler; }
    ...
    public void setBossSpawner(BossSpawner bossSpawner) { this.bossSpawner = bossSpawner; }
    public CollectedCoinsComponent getCollectedCoinsComponent() { return collectedCoinsComponent; }
    public void setCollectedCoinsComponent(CollectedCoinsComponent collectedCoinsComponent) { this.collectedCoinsComponent = collectedCoinsComponent; }
    public Entity getScore() { return score; }
    public void setScore(Entity score) { this.score = score; }
    public Entity getLife() { return life; }
    public void setLife(Entity life) { this.life = life; }
    public Entity getBomb() { return bomb; }
    public void setBomb(Entity bomb) { this.bomb = bomb; }
    public Entity getPlayer() { return player; }
    public void setPlayer(Entity player) { this.player = player; }
    public Entity getLevelDisplay() { return levelDisplay; }
    public void setLevelDisplay(Entity levelDisplay) { this.levelDisplay = levelDisplay; }
    public Entity getLevelProgressBar() { return levelProgressBar; }
    public void setLevelProgressBar(Entity levelProgressBar) { this.levelProgressBar = levelProgressBar; }
