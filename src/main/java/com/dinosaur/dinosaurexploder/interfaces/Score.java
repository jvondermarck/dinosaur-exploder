...
public interface Score {
  ...
  /** Summary : This method return the Score to the current Score */
  public int getScore();

  /** Summary : This method sets the Score to the current Score */
  public void setScore(int i);

  /** Summary : This method increment the Score to the current Score */
