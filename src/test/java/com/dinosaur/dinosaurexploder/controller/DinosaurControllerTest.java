...
class DinosaurControllerTest {
    ...
    public void initPhysics_ifInitGameWasNotCalled() {
        ...
        IllegalStateException ex =
                assertThrows(IllegalStateException.class, controller::initPhysics);
    ...
    public void initPhysics_andRegisterAll() {
        try (MockedConstruction<GameInitializer> initCons = mockConstruction(GameInitializer.class);
             MockedConstruction<CollisionRegistry> registryCons = mockConstruction(CollisionRegistry.class);
             MockedConstruction<GameActions> actionsCons = mockConstruction(GameActions.class);


             MockedConstruction<EnemyProjectilePlayerCollision> c1 = mockConstruction(EnemyProjectilePlayerCollision.class);
             MockedConstruction<PlayerCoinCollision> c2 = mockConstruction(PlayerCoinCollision.class);
             MockedConstruction<PlayerGreenDinoCollision> c3 = mockConstruction(PlayerGreenDinoCollision.class);
             MockedConstruction<PlayerHeartCollision> c4 = mockConstruction(PlayerHeartCollision.class);
             MockedConstruction<PlayerOrangeDinoCollision> c5 = mockConstruction(PlayerOrangeDinoCollision.class);
             MockedConstruction<PlayerRedDinoCollision> c6 = mockConstruction(PlayerRedDinoCollision.class);
             MockedConstruction<ProjectileEnemyProjectileCollision> c7 = mockConstruction(ProjectileEnemyProjectileCollision.class);
             MockedConstruction<ProjectileGreenDinoCollision> c8 = mockConstruction(ProjectileGreenDinoCollision.class);
             MockedConstruction<ProjectileOrangeDinoCollision> c9 = mockConstruction(ProjectileOrangeDinoCollision.class);
             MockedConstruction<ProjectileRedDinoCollision> c10 = mockConstruction(ProjectileRedDinoCollision.class)
        ) {
