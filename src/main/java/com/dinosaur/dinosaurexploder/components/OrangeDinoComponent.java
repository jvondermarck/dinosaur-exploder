 ...
 * the player to ram him. he has three times the lives than the current level.
 */
public class OrangeDinoComponent extends Component implements Dinosaur {
  ...
  /**
   * This method calculates the rotation, that the dino needs to always look in the direction of the
   * player and rotates it.
   */
  void rotateDino() {
    double oppositeSide;
    double adjacentSide;
  ...
  /**
   * Summary : This method damages the orange dino
   *
   * @param damage
   */
